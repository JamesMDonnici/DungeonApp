...
namespace DungeonLibrary
{
    public class Rabbit : Monster
    {
        ...
        {
            //Just handle the unique properties from your class.
            IsFluffy = isFluffy;
        }

        public Rabbit()
        {
            //Set values for this constructor so that when an instance of an object is created using this default ctor, the instance of a rabbit will already have some values for it's properties.
            //Set Max values
            MaxLife = 6;
            MaxDamage = 3;
            Name = "Baby Rabbit";
            ...
            MinDamage = 1;
            Life = 6;
            Description = "It's just a cute little bunny...Why would you want to fight it? Bully!";
            IsFluffy = false;
        }
